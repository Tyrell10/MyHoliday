...
(cl:defmethod cl:initialize-instance :after ((m <demo_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'demo_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Tyrell-msg:<demo_msg> is deprecated: use Tyrell-msg:demo_msg instead.")))

(cl:ensure-generic-function 'greeting-val :lambda-list '(m))
(cl:defmethod greeting-val ((m <demo_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Tyrell-msg:greeting-val is deprecated.  Use Tyrell-msg:greeting instead.")
  (greeting m))

(cl:ensure-generic-function 'number-val :lambda-list '(m))
(cl:defmethod number-val ((m <demo_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Tyrell-msg:number-val is deprecated.  Use Tyrell-msg:number instead.")
  (number m))
