...
(cl:defmethod cl:initialize-instance :after ((m <demo_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'demo_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Tyrell-srv:<demo_srv-request> is deprecated: use Tyrell-srv:demo_srv-request instead.")))

(cl:ensure-generic-function 'in-val :lambda-list '(m))
(cl:defmethod in-val ((m <demo_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Tyrell-srv:in-val is deprecated.  Use Tyrell-srv:in instead.")
  (in m))
...
(cl:defmethod cl:initialize-instance :after ((m <demo_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'demo_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Tyrell-srv:<demo_srv-response> is deprecated: use Tyrell-srv:demo_srv-response instead.")))

(cl:ensure-generic-function 'out-val :lambda-list '(m))
(cl:defmethod out-val ((m <demo_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Tyrell-srv:out-val is deprecated.  Use Tyrell-srv:out instead.")
  (out m))
